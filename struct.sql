CREATE TABLE photoalbum_users (id_user INT AUTO_INCREMENT PRIMARY KEY, name TEXT, md5 CHAR(32), email TEXT, invite INT);
CREATE TABLE photoalbum_albums (id_album INT AUTO_INCREMENT PRIMARY KEY, title TEXT, id_owner INT);
CREATE TABLE photoalbum_photos (id_photo INT AUTO_INCREMENT PRIMARY KEY, filename TEXT, id_album INT, imgw INT);
